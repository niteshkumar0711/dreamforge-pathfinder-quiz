...
const Register = () => {
  ...
  const handleRegister = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // For demonstration, we'll just accept any registration
      localStorage.setItem('isLoggedIn', 'true');
      localStorage.setItem('userName', name);
      
      toast({
        title: "Registration Successful",
        description: "Welcome to DreamForge! Your account has been created.",
      });
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center pt-24 pb-16 px-4">
        <div className="w-full max-w-md">
          <Card className="border-dreamforge-blue/20">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center text-dreamforge-dark dark:text-white">Create an account</CardTitle>
              <CardDescription className="text-center text-gray-500 dark:text-gray-400">
                Enter your details to create your DreamForge account
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="terms" className="text-sm text-gray-500 dark:text-gray-400 leading-tight cursor-pointer">
                    I agree to the{' '}
                    <Link to="/terms" className="text-dreamforge-blue hover:underline">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link to="/privacy" className="text-dreamforge-blue hover:underline">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
              ...
              <div className="flex gap-2">
                <Button 
                  ...
                  onClick={() => toast({
                    ...
                    description: "Google registration will be available in a future update.",
                  })}
                >
                ...
                <Button 
                  ...
                  onClick={() => toast({
                    title: "Feature coming soon",
                    description: "Facebook registration will be available in a future update.",
                  })}
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5 mr-2 text-[#1877F2]" aria-hidden="true">
                    <path
            ...
            <CardFooter className="justify-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link to="/login" className="text-dreamforge-blue font-medium hover:underline">
                  Sign in
                </Link>
              </p>
            </CardFooter>
